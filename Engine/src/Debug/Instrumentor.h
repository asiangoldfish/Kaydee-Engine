...
#define KD_PROFILE_BEGIN_SESSION(name, filepath)                               \
    ::Kaydee::Instrumentor::Get().BeginSession(name, filepath)
#define KD_PROFILE_END_SESSION() ::Kaydee::Instrumentor::Get().EndSession()
#define KD_PROFILE_SCOPE(myname)                                               \
    ::Kaydee::InstrumentationTimer C(timer, __LINE__)(myname)

// Use function name instead of filepath
#define KD_PROFILE_FUNCTION() KD_PROFILE_SCOPE(KD_FUNC_SIG)

#else

#define KD_PROFILE_BEGIN_SESSION(name, fielpath)
#define KD_PROFILE_END_SESSION()
#define KD_PROFILE_FUNCTION(name)
#define KD_PROFILE_SCOPE()
